...
public class Rebel {
	...
	public Rebel(Integer rebelId, String name, LocalDate birth, Location location, LocalDateTime locationUpdatedAt, Integer traitorReports, Inventory inventory, LocalDateTime createdAt) {
	...
	public boolean equals(Object o) {
		...
		Rebel rebel = (Rebel) o;
		return Objects.equals(rebelId, rebel.rebelId) && Objects.equals(name, rebel.name) && Objects.equals(birth, rebel.birth) && Objects.equals(location, rebel.location) && Objects.equals(locationUpdatedAt, rebel.locationUpdatedAt) && Objects.equals(traitorReports, rebel.traitorReports) && Objects.equals(inventory, rebel.inventory) && Objects.equals(createdAt, rebel.createdAt);
	}

	@Override
	public int hashCode() {
		return Objects.hash(rebelId, name, birth, location, locationUpdatedAt, traitorReports, inventory, createdAt);
	}
